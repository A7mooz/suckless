...
static const char col_cyan[]        = "#5b0077";
...
static const char *emoji_sel[] = { "rofimoji", NULL };
...
static const Key keys[] = {
	...
	{ ShiftMask,                    XK_Print,  spawn,          {.v = ssgui} },
	{ Mod4Mask,			            XK_v,      spawn,	       {.v = clipboard} },
	{ Mod4Mask,						XK_period,    spawn,          {.v = emoji_sel} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
